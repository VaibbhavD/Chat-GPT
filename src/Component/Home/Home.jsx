...
function Home() {
  return (
    <div className="h-full grid items-center justify-center text-white md:py-0 py-12 gap-10 ">
      ...
      <div className=" grid md:grid-cols-3 gap-5 text-center text-blue-200 md:mb-20">
